...
const Signup: React.FC = () => {
  ...
  function validate(): string | null {
    if (!email.trim()) return t("enterEmail") || "Please enter your email.";
    if (!password) return t("enterPassword") || "Please enter a password.";
    if (password.length < 6)
      return t("passwordTooShort") || "Password should be at least 6 characters.";
    if (password !== confirm)
      return t("passwordsDontMatch") || "Passwords do not match.";
    return null;
  }
    ...
    <>
        ...
        @media (min-width: 1024px) {
          ...
          .auth-left-side {
            background: 
              ...
              url("${import.meta.env.BASE_URL}assets/img3.jpg") center/cover no-repeat;
            display: flex;
            align-items: center;
            justify-content: center;
            position: relative;
      ...
      <div className="mobile-container">
        ...
        <div className="auth-card">
          ...
          <h1 className="auth-title">{t("createAccount") || "Create your account"}</h1>
          <p className="auth-sub">
            {t("signupSubtitle") || "Join us to unlock your personalized beauty insights."}
          </p>
          ...
          <form className="auth-form" onSubmit={submit}>
            ...
            <button className="btn-primary" disabled={busy}>
              {busy ? (t("pleaseWait") || "Please wait…") : (t("signup") || "Sign up")}
            </button>
      ...
      <div className="desktop-container">
        ...
        <div className="auth-left-side">
          <div className="side-content">
            ...
            <div className="tagline">Join Our AI Revolution</div>
            ...
            <p className="side-subtitle">
              Create your account to unlock personalized AI skin analysis and professional treatment recommendations
            </p>
          </div>
        </div>

        {/* Right Side - Signup Form for Desktop */}
        <div className="auth-right-side">
          <div className="auth-right-content">
            ...
            <div className="auth-left-desktop">
              ...
              <h1 className="auth-title-desktop">{t("createAccount") || "Create account"}</h1>
              <p className="auth-sub-desktop">
                {t("signupSubtitle") || "Join us to unlock powerful AI insights"}
              </p>
              ...
              <form className="auth-form" onSubmit={submit}>
                ...
                <button className="btn-primary-desktop" disabled={busy}>
                  {busy ? (t("pleaseWait") || "Please wait…") : (t("signup") || "Create account")}
                </button>
